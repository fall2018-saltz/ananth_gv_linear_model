...
data <- data.frame(fromJSON("hotel_survey.json"))                           # the data from json file is loaded using fromJSON function and converted to data frame using data.frame fucntion. 
